...
GradientParameter* Fmincg::calculate(int noThreads, int numberOfLabels, int maxIterations, double* aList, int ySize, int xColumnSize, double* yList, int totalLayerCount,
	...
	return Fmincg::calculate(noThreads, thetaRowCount, numberOfLabels, maxIterations, aList, ySize, xColumnSize, yList, totalLayerCount, neuronCounts, lambda, thetas);

}

GradientParameter* Fmincg::calculate(int noThreads, int thetaRowCount, int numberOfLabels, int maxIterations, double* aList, int ySize, int xColumnSize, double* yList,
		int layerCount, int* neuronCounts, double lambda, double* tList) {
